...
wrist - "that will let you fix the changes with no such propagation
...
job! Good lu--" She taps a button on the device and you suddenly feel
...
def main():
    ...
    while twice is None:
        for f in data:
            ...
            if twice is None and freq_tmp in freqs:
                twice = freq_tmp
                break
            else:
                freqs[freq_tmp] = 1

    print("[Star 1] Freq: %d" % freq)
    print("[Star 2] Twice: %d" % twice)
